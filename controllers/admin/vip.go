...
// List 列表
func (con VipController) List(c *gin.Context) {
...
// Detail 详情
func (con VipController) Detail(c *gin.Context) {
...
// Option 添加 编辑
func (con VipController) Option(c *gin.Context) {
...
// Delete 删除
func (con VipController) Delete(c *gin.Context) {
