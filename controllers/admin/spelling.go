...
func (con SpellingController) List(c *gin.Context) {
	...
	var count int64
	res := ay.Db.Model(&models.ClassSpelling{})
...
// Option 添加 编辑
func (con SpellingController) Option(c *gin.Context) {
	...
	if data.Id != 0 {
		...
		ay.Db.Create(&models.ClassSpelling{
...
func (con SpellingController) Delete(c *gin.Context) {
...
func (con SpellingController) Upload(c *gin.Context) {

	code, msg, name := Upload(c, "spell")
...
// GetAll 获取所有私教
func (con SpellingController) GetAll(c *gin.Context) {
	if Auth() == false {
		ay.Json{}.Msg(c, 401, "请登入", gin.H{})
		return
	}
